...
async def deliverability_guard_node(state: SalesAgentState) -> Dict[str, Any]:
    ...
    if not existing_domains and not existing_emails:
        try:
            ...
            ex_query = "SELECT LOWER(domain) as domain, LOWER(contact_email) as contact_email FROM sales_prospects WHERE (tenant_id = $1 OR tenant_id = '00000000-0000-0000-0000-000000000000') AND deal_stage IN ('OUTREACH_SENT', 'DEMO_SCHEDULED', 'CLOSED_WON');"
