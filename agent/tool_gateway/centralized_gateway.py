...
def _find_matching_binding(bindings: list, tool_name: str) -> dict | None:
    ...
    if norm_req in [
        ...
        "reschedule_appointment", "cancel_appointment", "edit_appointment",
...
async def execute_mcp_tool(
    ...
    try:
        ...
        elif provider_type == "google_docs" or "google_docs" in tool_name.lower() or "google_doc" in tool_name.lower() or "docs" in tool_name.lower():
        ...
        elif provider_type == "whatsapp" or "whatsapp" in tool_name.lower():
            return await execute_whatsapp_tool(tool_name, arguments, credentials, tenant_id=tenant_id)
